...
----------------------------------------------------------------------------------------------------------------
---- Development Tickets
--SELECT v_rpt_Service.TicketNbr AS 'Ticket #'
...
--	WHERE  v_rpt_Service.Board_Name = N'10 Development' 
--		AND v_rpt_Service.Closed_Flag = 0
--		AND v_rpt_Service.company_name = N'Filmquest Group'
--	ORDER BY [Status], [Hours Worked] desc
...
SET @StartDt = '01/01/2017'
SET @EndDt = '03/31/2017'
