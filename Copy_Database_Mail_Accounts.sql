-- This script will look at all Database Mail accounts on the current server and generate a script to recreate them
-- IMPORTANT!  After the script is generated, find all places were NotTheRealPassword exists and put the real password in there!
