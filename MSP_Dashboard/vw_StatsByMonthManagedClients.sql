-- SELECT * FROM vw_StatsByMonthManagedClients
...
-- This is only clients of type - 10 Client - Managed Services
------------------------------------------------------------

USE MSP_Dashboard
GO

IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_StatsByMonthManagedClients]'))
	DROP VIEW dbo.vw_StatsByMonthManagedClients
GO

CREATE VIEW dbo.vw_StatsByMonthManagedClients
AS 
