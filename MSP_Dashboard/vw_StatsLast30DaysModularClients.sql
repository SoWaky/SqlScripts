-- SELECT * FROM vw_StatsLast30DaysModularClients
...
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_StatsLast30DaysModularClients]'))
	DROP VIEW dbo.vw_StatsLast30DaysModularClients
GO

CREATE VIEW dbo.vw_StatsLast30DaysModularClients
AS 
