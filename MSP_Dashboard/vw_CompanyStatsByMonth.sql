-- SELECT * FROM vw_CompanyStatsByMonth

------------------------------------------------------------
-- The vw_CompanyStatsByMonth View includes all fields from the CompanyStatsByMonth table 
...
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_CompanyStatsByMonth]'))
	DROP VIEW dbo.vw_CompanyStatsByMonth
GO

CREATE VIEW dbo.vw_CompanyStatsByMonth
AS 
SELECT ms.*
