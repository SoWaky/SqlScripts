-- SELECT * FROM vw_StatsLast30Days
...
IF  EXISTS (SELECT * FROM sys.views WHERE object_id = OBJECT_ID(N'[dbo].[vw_StatsLast30Days]'))
	DROP VIEW dbo.vw_StatsLast30Days
GO

CREATE VIEW dbo.vw_StatsLast30Days
AS 
